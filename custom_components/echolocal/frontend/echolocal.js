...
`;var je=26,Tt=135,Rt=270,_=100,k=100,K=84,Pt=38,T=class extends v{constructor(){super(...arguments);this.level="";this.floor="";this.gate="";this.mode="";this.muted=!1;this.held=null;this.grab=t=>{let e=t.currentTarget;e.setPointerCapture(t.pointerId);let r=this.hass.states[this.gate]?.attributes??{},n=r.min??0,o=r.max??20,l=r.step??1,c=this.number(this.floor)??0,h=this.number(this.level)??0,g=Math.max(c+je,h+3),f=H=>{let W=e.getBoundingClientRect(),qi=H.clientX-W.left-W.width/2,Bi=H.clientY-W.top-W.height/2,Bt=Math.atan2(Bi,qi)*180/Math.PI-Tt;for(;Bt<0;)Bt+=360;let Ki=re(Math.min(Bt,Rt)/Rt);return Math.max(n,Math.min(o,Math.round(Ki*(g-c)/l)*l))},w=H=>{this.held=f(H)},$=H=>{e.removeEventListener("pointermove",w),e.removeEventListener("pointerup",$),e.removeEventListener("pointercancel",$);let W=f(H);this.held=null,this.hass.callService("number","set_value",{entity_id:this.gate,value:W})};e.addEventListener("pointermove",w),e.addEventListener("pointerup",$),e.addEventListener("pointercancel",$),this.held=f(t)}}render(){let t=this.number(this.level),e=this.number(this.floor),r=this.held??this.number(this.gate);if(t===null||e===null||r===null)return p;let n=this.hass.states[this.mode],o=Fe(n?.state),l=Math.max(e+je,t+3),c=re((t-e)/(l-e)),h=re(r/(l-e)),g=t>=e+r&&!this.muted;return a`
    ...
    `}number(t){let e=Number(this.hass?.states?.[t]?.state);return Number.isFinite(e)?e:null}};T.styles=b(De),d([u({attribute:!1})],T.prototype,"hass",2),d([u()],T.prototype,"level",2),d([u()],T.prototype,"floor",2),d([u()],T.prototype,"gate",2),d([u()],T.prototype,"mode",2),d([u({type:Boolean})],T.prototype,"muted",2),d([m()],T.prototype,"held",2),T=d([y("echolocal-array")],T);function Fe(s){let i=(s??"").toLowerCase();return i.includes("center")||i.includes("centre")?"one":i.includes("beam")?"beam":"sum"}function mr(s,i){return[[_,k],...Array.from({length:6},(e,r)=>{let n=(-90+r*60)*Math.PI/180;return[_+Pt*Math.cos(n),k+Pt*Math.sin(n)]})].map(([e,r],n)=>x`<circle class="capsule" data-on=${String(!i&&(s!=="one"||n===0))}
    ...
    ${i.map(([t,e],r)=>x`<circle class="capsule" data-on=${String(s!=="one"||r===0)}
      ...
      x2=${(_+Pt*Math.cos(t)).toFixed(1)} y2=${(k+Pt*Math.sin(t)).toFixed(1)}></line>`})}function vr(){return x`<path class="beam" d="M${_} ${k}C${_-34} ${k-30} ${_-24} ${k-66} ${_} ${k-66}C${_+24} ${k-66} ${_+34} ${k-30} ${_} ${k}Z"></path>`}function We(){let s=Tt*Math.PI/180,i=(Tt+Rt)*Math.PI/180;return`M${(_+K*Math.cos(s)).toFixed(2)} ${(k+K*Math.sin(s)).toFixed(2)}
    A${K} ${K} 0 1 1 ${(_+K*Math.cos(i)).toFixed(2)} ${(k+K*Math.sin(i)).toFixed(2)}`}function br(s){let i=(Tt+s*Rt)*Math.PI/180,t=K-8,e=K+8;return x`<line class="notch"
...
`;var ct=null,Ir=5*6e4,M=class extends v{constructor(){super(...arguments);this.device="";this.turn="";this.filename="recording.wav";this.at=0;this.busy=!1;this.playing=!1;this.gone=!1;this.play=async()=>{if(this.playing){ct?.audio.pause();return}let t=await this.fetch();if(!t)return;ct?.stop();let e=new Audio(t),r=()=>{this.playing=!1,ct?.audio===e&&(ct=null)};e.addEventListener("ended",r),e.addEventListener("pause",r),ct={audio:e,stop:()=>e.pause()},this.playing=!0,e.play().catch(r)};this.save=async()=>{let t=await this.fetch();if(!t)return;let e=document.createElement("a");e.href=t,e.download=this.filename,e.click()}}disconnectedCallback(){super.disconnectedCallback(),this.playing&&ct?.audio.pause()}updated(){if(!this.hass||!this.turn||this.checkedTurn===this.turn)return;if(this.checkedTurn=this.turn,this.present=void 0,this.gone=!1,this.at&&Date.now()-this.at<Ir){this.present=!0;return}let t=this.device?oe(this.hass,this.device,Je):void 0;t&&ii(this.hass,t).then(e=>{this.checkedTurn===this.turn&&(this.present=e.has(this.turn))})}render(){return!this.turn||!this.action()||this.present!==!0?p:this.gone?a`<span class="gone" title="The device no longer has this recording">
    ...
    `}action(){return this.device?oe(this.hass,this.device,Ze):void 0}async fetch(){let t=ei(this.turn);if(t)return t;let e=this.action();if(!e)return null;this.busy=!0;try{let r=await ri(this.hass,e,this.turn);return this.gone=!r,r||this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:"That recording is no longer on the device."},bubbles:!0,composed:!0})),r}finally{this.busy=!1}}};M.styles=b(si),d([u({attribute:!1})],M.prototype,"hass",2),d([u()],M.prototype,"device",2),d([u()],M.prototype,"turn",2),d([u()],M.prototype,"filename",2),d([u({type:Number})],M.prototype,"at",2),d([m()],M.prototype,"busy",2),d([m()],M.prototype,"playing",2),d([m()],M.prototype,"present",2),d([m()],M.prototype,"gone",2),M=d([y("echolocal-recording")],M);var Ur=14,E=class extends v{constructor(){super(...arguments);this.device="";this.deviceId="";this.live=[];this.asked=!1;this.loading=!0}updated(){this.asked||!this.hass||!this.deviceId||(this.asked=!0,this.listen())}disconnectedCallback(){super.disconnectedCallback(),this.stop?.()}render(){let t=this.merged(),e=t.some(r=>r.turn&&at(r.turn).length>0);return a`
      <div class="caption">
        Recent turns
...
`;var ae=135,le=270,Nt=100,It=100,dt=78,qr={White:"mdi:grain",Pink:"mdi:blur",Brown:"mdi:waveform",Rain:"mdi:weather-pouring",Ocean:"mdi:waves",Brook:"mdi:water",Wind:"mdi:weather-windy",Fire:"mdi:fireplace",Crickets:"mdi:bug-outline",Fan:"mdi:fan",Cabin:"mdi:airplane"},pt="None",G=class extends v{constructor(){super(...arguments);this.player="";this.jack="";this.grab=t=>{let e=t.currentTarget;e.setPointerCapture(t.pointerId);let r=c=>{let h=e.getBoundingClientRect(),g=c.clientX-h.left-h.width/2,f=c.clientY-h.top-h.height/2,w=Math.atan2(f,g)*180/Math.PI-ae;for(;w<0;)w+=360;let $=Math.max(0,Math.min(1,Math.min(w,le)/le));return Math.round($*30)/30},n=c=>this.hass.callService("media_player","volume_set",{entity_id:this.player,volume_level:r(c)}),o=c=>n(c),l=c=>{e.removeEventListener("pointermove",o),e.removeEventListener("pointerup",l),e.removeEventListener("pointercancel",l),n(c)};e.addEventListener("pointermove",o),e.addEventListener("pointerup",l),e.addEventListener("pointercancel",l),n(t)}}render(){let t=this.hass.states[this.player];if(!t)return p;let e=Number(t.attributes.volume_level??0),r=t.attributes.is_volume_muted===!0,n=this.jack?this.hass.states[this.jack]?.state==="on":!1;return a`
    ...
    `}};G.styles=b(oi),d([u({attribute:!1})],G.prototype,"hass",2),d([u()],G.prototype,"player",2),d([u()],G.prototype,"jack",2),G=d([y("echolocal-volume")],G);var Y=class extends v{constructor(){super(...arguments);this.layers=[];this.busy=!1}render(){let t=this.layers.map(o=>this.hass.states[o]?.state??pt),e=(this.hass.states[this.layers[0]]?.attributes.options??[]).filter(o=>o!==pt),r=t.every(o=>o!==pt),n=o=>t.indexOf(o);return a`
      <div class="caption">
        Generated sound
    ...
    >
      Run
        ...
        ${r?a`<span class="unit">${r}</span>`:p}`})}tile({entityId:t,label:e,name:r},n,o){let l=this.hass.states[t].attributes.icon,c=n&&l?.includes("mic")&&l.includes("off"),h=this.help?Ge(r):void 0;return a`<div class="tile" data-active=${String(n&&!c)} data-alert=${String(!!c)}>
      <div class="top">
    ...
    </div>`}tapped(t,e){if(t.segments[e]){this.picked=this.picked===e?null:e;return}if(this.switchedOff(t)[e]){this.offering=e;return}this.open({kind:"ring",slot:0})}switchedOff(t){return wi(this.hass,t)}offer(t,e){let r=this.switchedOff(t),n=async o=>{for(let l of o)l&&await $i(this.hass,l);this.offering=null,this.picked=e};return a`<div class="foot">
      <div class="label">
...
`;I({path:"",title:"Home",icon:"mdi:view-grid-outline",element:"echolocal-home",order:0});var Ii="echolocal:home:grouped",U=class extends v{constructor(){super(...arguments);this.narrow=!1;this.known=[];this.asked=!1;this.grouped=localStorage.getItem(Ii)!=="no";this.cards=new Map}updated(){this.asked||!this.hass||(this.asked=!0,this.load())}render(){if(!this.hass)return p;let t=C(this.hass);if(!t.length)return a`<div class="empty">
    ...
    </div>`}card(t,e){let r=`${t}/${e}`,n=this.cards.get(r);return n||(n=document.createElement("echolocal-satellite-card"),n.setConfig({device_id:e}),this.cards.set(r,n)),n.hass=this.hass,n}async load(){this.known=await Ft(this.hass)}};U.styles=b(Ni),d([u({attribute:!1})],U.prototype,"hass",2),d([u({type:Boolean})],U.prototype,"narrow",2),d([m()],U.prototype,"known",2),d([m()],U.prototype,"asked",2),d([m()],U.prototype,"grouped",2),U=d([y("echolocal-home")],U);var Ui=`:host{display:block}.make{display:flex;gap:8px;margin-bottom:20px}ha-input.new{flex:1;max-width:280px}table{width:100%;border-collapse:collapse;font-size:.9rem}th{padding:8px 10px;text-align:center;font-weight:600;font-size:.72rem;text-transform:uppercase;letter-spacing:.07em;color:var(--secondary-text-color);white-space:nowrap}th.who{text-align:left}th .label{display:flex;align-items:center;justify-content:center;gap:4px}th ha-input{--ha-input-text-align: center}th ha-icon-button{--mdc-icon-size: 15px;color:var(--secondary-text-color)}th ha-icon-button:hover{color:var(--error-color, #db4437)}td{padding:10px;border-top:1px solid color-mix(in srgb,var(--primary-text-color) 10%,transparent);text-align:center}td.who{text-align:left;color:var(--primary-text-color)}.none{color:var(--secondary-text-color);max-width:52ch;line-height:1.5}
...
`;I({path:"activity",title:"Activity",icon:"mdi:timeline-text-outline",element:"echolocal-activity",order:20});var ds=14,j=class extends v{constructor(){super(...arguments);this.seen=[];this.only="";this.asked=!1;this.loading=!0}updated(){this.asked||!this.hass||(this.asked=!0,this.listen())}disconnectedCallback(){super.disconnectedCallback(),this.stop?.()}render(){if(!this.hass)return p;let t=this.names(),e=this.only?this.seen.filter(n=>n.turn.device===this.only):this.seen,r=Math.max(1,...e.map(n=>lt(n.turn)));return a`
    ...
    `}row(t,e,r){let n=at(t.turn),o=lt(t.turn),l=t.turn.outcome!=="completed",c=e[t.turn.device],h=c?.label??"elsewhere";return a`<div class="turn">
...
`;I({path:"wake-words",title:"Wake words",icon:"mdi:waveform",element:"echolocal-words",order:10,admin:!0});var J=class extends v{constructor(){super(...arguments);this.words=[];this.asked=!1;this.again=()=>this.requestUpdate()}connectedCallback(){super.connectedCallback(),window.addEventListener(it,this.again)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(it,this.again)}updated(){this.asked||!this.hass||(this.asked=!0,this.load())}render(){if(!this.hass)return p;let t=this.chosen(),e=new Set(this.words.filter(n=>n.problems.length&&n.wake_word).map(n=>n.wake_word)),r=new Set(t.flatMap(n=>n.words));return a`
    ...
    </button>`}body(t){let e=this.made.get(t.path);return e||(e=document.createElement(t.element),this.made.set(t.path,e)),e.hass=this.hass,e.narrow=this.narrow,e}where(){return this.route?ue(this.base(),this.route.path):this.at}base(){return this.route?.prefix??"/echolocal"}};F.styles=b(Si),d([u({attribute:!1})],F.prototype,"hass",2),d([u({type:Boolean})],F.prototype,"narrow",2),d([u({attribute:!1})],F.prototype,"route",2),d([u({attribute:!1})],F.prototype,"panel",2),d([m()],F.prototype,"at",2),F=d([y("echolocal-panel")],F);window.customCards=window.customCards??[];window.customCards.some(s=>s.type==="echolocal-satellite-card")||window.customCards.push({type:"echolocal-satellite-card",name:"EchoLocal Satellite",description:"An EchoLocal satellite, drawn as itself, with its ring and mute live.",preview:!0,documentationURL:"https://github.com/ygelfand/echolocal-hacs"});
