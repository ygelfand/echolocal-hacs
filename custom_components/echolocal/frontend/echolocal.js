var Yi=Object.defineProperty;var Vi=Object.getOwnPropertyDescriptor;var c=(r,i,t,e)=>{for(var s=e>1?void 0:e?Vi(i,t):i,n=r.length-1,o;n>=0;n--)(o=r[n])&&(s=(e?o(i,t,s):o(s))||s);return e&&s&&Yi(i,t,s),s};/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ls={attribute:!0,type:String,converter:ut,reflect:!1,hasChanged:At},cs=(r=ls,i,t)=>{let{kind:e,metadata:s}=t,n=globalThis.litPropertyMetadata.get(s);if(n===void 0&&globalThis.litPropertyMetadata.set(s,n=new Map),e==="setter"&&((r=Object.create(r)).wrapped=!0),n.set(t.name,r),e==="accessor"){let{name:o}=t;return{set(l){let d=i.get.call(this);i.set.call(this,l),this.requestUpdate(o,d,r,!0,l)},init(l){return l!==void 0&&this.C(o,void 0,r,l),l}}}if(e==="setter"){let{name:o}=t;return function(l){let d=this[o];i.call(this,l),this.requestUpdate(o,d,r,!0,l)}}throw Error("Unsupported decorator location: "+e)};function u(r){return(i,t)=>typeof t=="object"?cs(r,i,t):((e,s,n)=>{let o=s.hasOwnProperty(n);return s.constructor.createProperty(n,e),o?Object.getOwnPropertyDescriptor(s,n):void 0})(r,i,t)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */var yt=12,Ie=2.2,F=100,q=100,De=500;function Ue(r,i){let t=Array.from({length:yt},(e,s)=>{let n=-90+360/yt*s+Ie/2,o=-90+360/yt*(s+1)-Ie/2;return hs(93,82,n,o)});return w`
  ...
  `}function ps(){return w``}function hs(r,i,t,e){let s=($,T)=>{let W=T*Math.PI/180;return[(F+$*Math.cos(W)).toFixed(2),(q+$*Math.sin(W)).toFixed(2)]},[n,o]=s(r,t),[l,d]=s(r,e),[h,g]=s(i,e),[f,x]=s(i,t);return`M${n} ${o}A${r} ${r} 0 0 1 ${l} ${d}L${h} ${g}A${i} ${i} 0 0 0 ${f} ${x}Z`}var We=`:host {
  display: block;
}
...
`;var Fe=26,Mt=135,Ht=270,_=100,k=100,G=84,Pt=38,H=class extends v{constructor(){super(...arguments);this.level="";this.floor="";this.gate="";this.mode="";this.muted=!1;this.held=null;this.grab=t=>{let e=t.currentTarget;e.setPointerCapture(t.pointerId);let s=this.hass.states[this.gate]?.attributes??{},n=s.min??0,o=s.max??20,l=s.step??1,d=this.number(this.floor)??0,h=this.number(this.level)??0,g=Math.max(d+Fe,h+3),f=T=>{let W=e.getBoundingClientRect(),Bi=T.clientX-W.left-W.width/2,Ki=T.clientY-W.top-W.height/2,Kt=Math.atan2(Ki,Bi)*180/Math.PI-Mt;for(;Kt<0;)Kt+=360;let Gi=re(Math.min(Kt,Ht)/Ht);return Math.max(n,Math.min(o,Math.round(Gi*(g-d)/l)*l))},x=T=>{this.held=f(T)},$=T=>{e.removeEventListener("pointermove",x),e.removeEventListener("pointerup",$),e.removeEventListener("pointercancel",$);let W=f(T);this.held=null,this.hass.callService("number","set_value",{entity_id:this.gate,value:W})};e.addEventListener("pointermove",x),e.addEventListener("pointerup",$),e.addEventListener("pointercancel",$),this.held=f(t)}}render(){let t=this.number(this.level),e=this.number(this.floor),s=this.held??this.number(this.gate);if(t===null||e===null||s===null)return p;let n=this.hass.states[this.mode],o=qe(n?.state),l=Math.max(e+Fe,t+3),d=re((t-e)/(l-e)),h=re(s/(l-e)),g=t>=e+s&&!this.muted;return a`
      ...
      <div class="side">
        ...
        <div class="modes">
          ${(n?.attributes.options??[]).map(f=>a`<button
            ...
            >
              <svg viewBox="0 0 40 40">${fs(qe(f))}</svg>
              <span>${f}</span>
            </button>`)}
        </div>
...
`;var Et=[["White",[255,255,255]],["Warm",[255,190,120]],["Red",[255,40,40]],["Orange",[255,130,20]],["Yellow",[250,230,60]],["Green",[60,220,90]],["Teal",[40,220,200]],["Blue",[60,140,255]],["Violet",[150,90,255]],["Pink",[255,90,200]]];function Ss(r,i){return Array.isArray(r)&&i.every((t,e)=>r[e]===t)}var R=class extends v{constructor(){super(...arguments);this.light="";this.muted="";this.failure="";this.room="";this.target="rest"}render(){let t=this.hass.states[this.light];if(!t)return p;let e=this.situations(),s=e.find(o=>o.key===this.target)??e[0],n=t.attributes.brightness??255;return a`
      <div class="dim">
      ...
      <div class="hue">
        ...
        <div class="swatches">
          ${Et.map(([o,l])=>a`<button
              ...
              title=${o}
              aria-label=${o}
              data-on=${String(Ss(t.attributes.rgb_color,l))}
...
`;var lt=null,M=class extends v{constructor(){super(...arguments);this.device="";this.turn="";this.filename="recording.wav";this.busy=!1;this.playing=!1;this.gone=!1;this.play=async()=>{if(this.playing){lt?.audio.pause();return}let t=await this.fetch();if(!t)return;lt?.stop();let e=new Audio(t),s=()=>{this.playing=!1,lt?.audio===e&&(lt=null)};e.addEventListener("ended",s),e.addEventListener("pause",s),lt={audio:e,stop:()=>e.pause()},this.playing=!0,e.play().catch(s)};this.save=async()=>{let t=await this.fetch();if(!t)return;let e=document.createElement("a");e.href=t,e.download=this.filename,e.click()}}disconnectedCallback(){super.disconnectedCallback(),this.playing&&lt?.audio.pause()}updated(){if(!this.hass||!this.turn||this.checkedTurn===this.turn)return;this.checkedTurn=this.turn,this.present=void 0,this.gone=!1;let t=this.device?ae(this.hass,this.device,Le):void 0;if(!t){this.present=!0;return}ri(this.hass,t).then(e=>{this.checkedTurn===this.turn&&(this.present=e.has(this.turn))})}render(){return!this.turn||!this.action()||this.present!==!0?p:this.gone?a`<span class="gone" title="The device no longer has this recording">
    ...
    `}action(){return this.device?ae(this.hass,this.device,Qe):void 0}async fetch(){let t=si(this.turn);if(t)return t;let e=this.action();if(!e)return null;this.busy=!0;try{let s=await ni(this.hass,e,this.turn);return this.gone=!s,s}finally{this.busy=!1}}};M.styles=b(oi),c([u({attribute:!1})],M.prototype,"hass",2),c([u()],M.prototype,"device",2),c([u()],M.prototype,"turn",2),c([u()],M.prototype,"filename",2),c([m()],M.prototype,"busy",2),c([m()],M.prototype,"playing",2),c([m()],M.prototype,"present",2),c([m()],M.prototype,"gone",2),M=c([y("echolocal-recording")],M);var Ds=14,E=class extends v{constructor(){super(...arguments);this.device="";this.deviceId="";this.live=[];this.asked=!1;this.loading=!0}updated(){this.asked||!this.hass||!this.deviceId||(this.asked=!0,this.listen())}disconnectedCallback(){super.disconnectedCallback(),this.stop?.()}render(){let t=this.merged(),e=t.some(s=>s.turn&&ot(s.turn).length>0);return a`
      <div class="caption">
        Recent turns
        ${t.length?a`<span>${t.length===1?"1 turn":`${t.length} turns`}</span>`:p}
      </div>
      ${e?a`<div class="legend">
            ${[["listen_ms","Listen"],["think_ms","Think"],["speak_ms","Reply"]].map(([s,n])=>a`<span class="key"
                ><span class="dot slice" data-phase=${s}></span>${n}</span
              >`)}
          </div>`:p}
      ${t.length?a`<div class="turns">${t.map(s=>this.row(s,this.scale(t)))}</div>`:this.loading?a`<div class="loading"><ha-spinner size="medium"></ha-spinner></div>`:a`<div class="none">No recent activity found.</div>`}
    `}scale(t){return Math.max(1,...t.map(e=>e.turn?at(e.turn):0))}row(t,e){let s=t.turn,n=s?ot(s):[],o=s?at(s):0;return a`<div class="turn">
    ...
    </div>`}merged(){return[...this.live].sort((t,e)=>e.at-t.at)}async listen(){let t=new Date(Date.now()-Ds*864e5),e=this.deviceId?[this.deviceId]:[];try{this.stop=await zt(this.hass,t,e,s=>{this.loading=!1,s.length&&(this.live=[...s.map(({at:n,turn:o})=>({at:n,wake:o.wake_word,heard:o.heard,reply:o.reply,turn:o})),...this.live])})}catch{this.loading=!1}}};E.styles=b(ei),c([u({attribute:!1})],E.prototype,"hass",2),c([u()],E.prototype,"device",2),c([u()],E.prototype,"deviceId",2),c([m()],E.prototype,"live",2),c([m()],E.prototype,"asked",2),c([m()],E.prototype,"loading",2),E=c([y("echolocal-history")],E);function Us(r){return new Date(r).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"})}function Ws(r){let i=new Date(r.at).toISOString().replace(/[:.]/g,"-").slice(0,19),t=r.wake.toLowerCase().replace(/[^a-z0-9]+/g,"-");return`${i}-${t}.wav`}var ai=`:host {
  display: block;
  padding: 14px;
  border-radius: 14px;
  background: color-mix(in srgb, var(--primary-text-color) 5%, transparent);
...
`;var le=135,ce=270,Ot=100,Nt=100,ct=78,qs={White:"mdi:grain",Pink:"mdi:blur",Brown:"mdi:waveform",Rain:"mdi:weather-pouring",Ocean:"mdi:waves",Brook:"mdi:water",Wind:"mdi:weather-windy",Fire:"mdi:fireplace",Crickets:"mdi:bug-outline",Fan:"mdi:fan",Cabin:"mdi:airplane"},dt="None",Y=class extends v{constructor(){super(...arguments);this.player="";this.jack="";this.grab=t=>{let e=t.currentTarget;e.setPointerCapture(t.pointerId);let s=d=>{let h=e.getBoundingClientRect(),g=d.clientX-h.left-h.width/2,f=d.clientY-h.top-h.height/2,x=Math.atan2(f,g)*180/Math.PI-le;for(;x<0;)x+=360;let $=Math.max(0,Math.min(1,Math.min(x,ce)/ce));return Math.round($*30)/30},n=d=>this.hass.callService("media_player","volume_set",{entity_id:this.player,volume_level:s(d)}),o=d=>n(d),l=d=>{e.removeEventListener("pointermove",o),e.removeEventListener("pointerup",l),e.removeEventListener("pointercancel",l),n(d)};e.addEventListener("pointermove",o),e.addEventListener("pointerup",l),e.addEventListener("pointercancel",l),n(t)}}render(){let t=this.hass.states[this.player];if(!t)return p;let e=Number(t.attributes.volume_level??0),s=t.attributes.is_volume_muted===!0,n=this.jack?this.hass.states[this.jack]?.state==="on":!1;return a`
      ...
      <div class="side">
        <div class="state">${Bs(t.state)}</div>
        <div class="badges">
    ...
    ></ha-control-switch>`}get muted(){let t=this.widgets.find(e=>e.roles.mute)?.roles.mute;return!!t&&this.hass.states[t]?.state==="on"}explained(t){let e=this.help?Xe(t.widget):void 0;return e?a`<div class="explained">
      ...
      ></ha-control-switch>`})}slider(t){let{entityId:e}=t,s=this.hass.states[e],n=s.attributes,o=n.min??0,l=n.max??100,d=this.held[e]??Number(s.state);return this.tile(t,!1,{trail:a`<span class="reading">${Number.isNaN(d)?"\u2014":d}</span>
      ...
      ></ha-control-slider>`})}options(t){let{entityId:e}=t,s=this.hass.states[e],n=s.attributes.options??[],o=n.map(h=>({value:h,label:h})),l=h=>{h&&h!==s.state&&this.hass.callService("select","select_option",{entity_id:e,option:h})},d=s.state==="unavailable";return this.tile(t,!1,{trail:n.length===2?a`<div class="pills">
              ${n.map(h=>a`<button
                  class="pill"
    ...
    >
      Run
        ...
        ${s?a`<span class="unit">${s}</span>`:p}`})}tile({entityId:t,label:e,name:s},n,o){let l=this.hass.states[t].attributes.icon,d=n&&l?.includes("mic")&&l.includes("off"),h=this.help?Ve(s):void 0;return a`<div class="tile" data-active=${String(n&&!d)} data-alert=${String(!!d)}>
      <div class="top">
...
`;var zi="mic_mute",Oi="ring",Ni="speaker",X=class extends v{constructor(){super(...arguments);this.said=""}render(){if(!this.hass||!this.group)return p;let t=this.group.devices,e=Bt(this.hass,t,zi),s=Bt(this.hass,t,Oi);return a`<div class="bar">
      ...
      ${s.entities.length?this.toggle("mdi:lightbulb-outline","Ring",s,()=>this.write(Oi,"light",s.value==="on"?"turn_off":"turn_on")):p}
      ${this.has(Ni)?a`<button title="Stop whatever is playing" @click=${()=>this.write(Ni,"media_player","media_stop")}>
...
`;O({path:"groups",title:"Groups",icon:"mdi:group",element:"echolocal-groups",order:30,admin:!0});var I=class extends v{constructor(){super(...arguments);this.known=[];this.asked=!1;this.naming="";this.busy=!1}connectedCallback(){super.connectedCallback(),this.hass?.connection?.subscribeEvents(()=>this.load(),"label_registry_updated").then(t=>this.stop=t).catch(()=>{})}disconnectedCallback(){super.disconnectedCallback(),this.stop?.()}updated(){this.asked||!this.hass||(this.asked=!0,this.load())}render(){if(!this.hass)return p;let t=C(this.hass),e=this.known;return a`
    ...
    `}head(t){let e=qt(C(this.hass),this.known).find(s=>s.id===t.label_id)?.devices.length;return a`<th>
      <div class="label">
        <ha-input
          .value=${t.name}
...
`;O({path:"activity",title:"Activity",icon:"mdi:timeline-text-outline",element:"echolocal-activity",order:20});var lr=14,D=class extends v{constructor(){super(...arguments);this.seen=[];this.only="";this.asked=!1;this.loading=!0}updated(){this.asked||!this.hass||(this.asked=!0,this.listen())}disconnectedCallback(){super.disconnectedCallback(),this.stop?.()}render(){if(!this.hass)return p;let t=this.names(),e=this.only?this.seen.filter(n=>n.turn.device===this.only):this.seen,s=Math.max(1,...e.map(n=>at(n.turn)));return a`
    ...
    </div>`}names(){let t={};for(let e of C(this.hass))t[e.id]={label:S(e),node:e.name??""};return t}async listen(){let t=new Date(Date.now()-lr*864e5),e=C(this.hass).map(s=>s.id);if(!e.length){this.asked=!1;return}try{this.stop=await zt(this.hass,t,e,s=>{this.loading=!1,s.length&&(this.seen=[...s,...this.seen].sort((n,o)=>o.at-n.at))})}catch{this.loading=!1}}};D.styles=b(Wi),c([u({attribute:!1})],D.prototype,"hass",2),c([m()],D.prototype,"seen",2),c([m()],D.prototype,"only",2),c([m()],D.prototype,"asked",2),c([m()],D.prototype,"loading",2),D=c([y("echolocal-activity")],D);function cr(r,i){let t=new Date(r.at).toISOString().replace(/[:.]/g,"-").slice(0,19),e=s=>s.toLowerCase().replace(/[^a-z0-9]+/g,"-");return`${t}-${e(i)}-${e(r.turn.wake_word)}.wav`}function dr(r){return new Date(r).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"})}var ji=`:host {
  display: block;
}
...
`;async function ye(r){try{return(await r.callWS({type:"echolocal/wake_words/list"}))?.wake_words??[]}catch{return[]}}var z=class extends v{constructor(){super(...arguments);this.words=[];this.over=!1;this.busy=!1;this.said="";this.asked=!1;this.dropped=t=>{t.preventDefault(),this.over=!1,this.add(t.dataTransfer?.files??null)}}updated(){this.asked||!this.hass||(this.asked=!0,this.refresh())}render(){return a`
      <div
        class="zone"
