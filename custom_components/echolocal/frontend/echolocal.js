var Xi=Object.defineProperty;var Zi=Object.getOwnPropertyDescriptor;var c=(s,i,t,e)=>{for(var r=e>1?void 0:e?Zi(i,t):i,n=s.length-1,o;n>=0;n--)(o=s[n])&&(r=(e?o(i,t,r):o(r))||r);return e&&r&&Xi(i,t,r),r};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var St=globalThis,Ct=St.ShadowRoot&&(St.ShadyCSS===void 0||St.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,xe=Symbol(),ye=new WeakMap,At=class{constructor(i,t,e){if(this._$cssResult$=!0,e!==xe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=i,this.t=t}get styleSheet(){let i=this.o,t=this.t;if(Ct&&i===void 0){let e=t!==void 0&&t.length===1;e&&(i=ye.get(t)),i===void 0&&((this.o=i=new CSSStyleSheet).replaceSync(this.cssText),e&&ye.set(t,i))}return i}toString(){return this.cssText}},b=s=>new At(typeof s=="string"?s:s+"",void 0,xe);var we=(s,i)=>{if(Ct)s.adoptedStyleSheets=i.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of i){let e=document.createElement("style"),r=St.litNonce;r!==void 0&&e.setAttribute("nonce",r),e.textContent=t.cssText,s.appendChild(e)}},Yt=Ct?s=>s:s=>s instanceof CSSStyleSheet?(i=>{let t="";for(let e of i.cssRules)t+=e.cssText;return b(t)})(s):s;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var{is:Ji,defineProperty:Qi,getOwnPropertyDescriptor:Li,getOwnPropertyNames:tr,getOwnPropertySymbols:er,getPrototypeOf:ir}=Object,Mt=globalThis,$e=Mt.trustedTypes,rr=$e?$e.emptyScript:"",sr=Mt.reactiveElementPolyfillSupport,mt=(s,i)=>s,gt={toAttribute(s,i){switch(i){case Boolean:s=s?rr:null;break;case Object:case Array:s=s==null?s:JSON.stringify(s)}return s},fromAttribute(s,i){let t=s;switch(i){case Boolean:t=s!==null;break;case Number:t=s===null?null:Number(s);break;case Object:case Array:try{t=JSON.parse(s)}catch{t=null}}return t}},Ht=(s,i)=>!Ji(s,i),_e={attribute:!0,type:String,converter:gt,reflect:!1,useDefault:!1,hasChanged:Ht};Symbol.metadata??=Symbol("metadata"),Mt.litPropertyMetadata??=new WeakMap;var q=class extends HTMLElement{static addInitializer(i){this._$Ei(),(this.l??=[]).push(i)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(i,t=_e){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(i)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(i,t),!t.noAccessor){let e=Symbol(),r=this.getPropertyDescriptor(i,e,t);r!==void 0&&Qi(this.prototype,i,r)}}static getPropertyDescriptor(i,t,e){let{get:r,set:n}=Li(this.prototype,i)??{get(){return this[t]},set(o){this[t]=o}};return{get:r,set(o){let l=r?.call(this);n?.call(this,o),this.requestUpdate(i,l,e)},configurable:!0,enumerable:!0}}static getPropertyOptions(i){return this.elementProperties.get(i)??_e}static _$Ei(){if(this.hasOwnProperty(mt("elementProperties")))return;let i=ir(this);i.finalize(),i.l!==void 0&&(this.l=[...i.l]),this.elementProperties=new Map(i.elementProperties)}static finalize(){if(this.hasOwnProperty(mt("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(mt("properties"))){let t=this.properties,e=[...tr(t),...er(t)];for(let r of e)this.createProperty(r,t[r])}let i=this[Symbol.metadata];if(i!==null){let t=litPropertyMetadata.get(i);if(t!==void 0)for(let[e,r]of t)this.elementProperties.set(e,r)}this._$Eh=new Map;for(let[t,e]of this.elementProperties){let r=this._$Eu(t,e);r!==void 0&&this._$Eh.set(r,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(i){let t=[];if(Array.isArray(i)){let e=new Set(i.flat(1/0).reverse());for(let r of e)t.unshift(Yt(r))}else i!==void 0&&t.push(Yt(i));return t}static _$Eu(i,t){let e=t.attribute;return e===!1?void 0:typeof e=="string"?e:typeof i=="string"?i.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(i=>this.enableUpdating=i),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(i=>i(this))}addController(i){(this._$EO??=new Set).add(i),this.renderRoot!==void 0&&this.isConnected&&i.hostConnected?.()}removeController(i){this._$EO?.delete(i)}_$E_(){let i=new Map,t=this.constructor.elementProperties;for(let e of t.keys())this.hasOwnProperty(e)&&(i.set(e,this[e]),delete this[e]);i.size>0&&(this._$Ep=i)}createRenderRoot(){let i=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return we(i,this.constructor.elementStyles),i}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(i=>i.hostConnected?.())}enableUpdating(i){}disconnectedCallback(){this._$EO?.forEach(i=>i.hostDisconnected?.())}attributeChangedCallback(i,t,e){this._$AK(i,e)}_$ET(i,t){let e=this.constructor.elementProperties.get(i),r=this.constructor._$Eu(i,e);if(r!==void 0&&e.reflect===!0){let n=(e.converter?.toAttribute!==void 0?e.converter:gt).toAttribute(t,e.type);this._$Em=i,n==null?this.removeAttribute(r):this.setAttribute(r,n),this._$Em=null}}_$AK(i,t){let e=this.constructor,r=e._$Eh.get(i);if(r!==void 0&&this._$Em!==r){let n=e.getPropertyOptions(r),o=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:gt;this._$Em=r;let l=o.fromAttribute(t,n.type);this[r]=l??this._$Ej?.get(r)??l,this._$Em=null}}requestUpdate(i,t,e,r=!1,n){if(i!==void 0){let o=this.constructor;if(r===!1&&(n=this[i]),e??=o.getPropertyOptions(i),!((e.hasChanged??Ht)(n,t)||e.useDefault&&e.reflect&&n===this._$Ej?.get(i)&&!this.hasAttribute(o._$Eu(i,e))))return;this.C(i,t,e)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(i,t,{useDefault:e,reflect:r,wrapped:n},o){e&&!(this._$Ej??=new Map).has(i)&&(this._$Ej.set(i,o??t??this[i]),n!==!0||o!==void 0)||(this._$AL.has(i)||(this.hasUpdated||e||(t=void 0),this._$AL.set(i,t)),r===!0&&this._$Em!==i&&(this._$Eq??=new Set).add(i))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let i=this.scheduleUpdate();return i!=null&&await i,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[r,n]of this._$Ep)this[r]=n;this._$Ep=void 0}let e=this.constructor.elementProperties;if(e.size>0)for(let[r,n]of e){let{wrapped:o}=n,l=this[r];o!==!0||this._$AL.has(r)||l===void 0||this.C(r,void 0,n,l)}}let i=!1,t=this._$AL;try{i=this.shouldUpdate(t),i?(this.willUpdate(t),this._$EO?.forEach(e=>e.hostUpdate?.()),this.update(t)):this._$EM()}catch(e){throw i=!1,this._$EM(),e}i&&this._$AE(t)}willUpdate(i){}_$AE(i){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(i)),this.updated(i)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(i){return!0}update(i){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(i){}firstUpdated(i){}};q.elementStyles=[],q.shadowRootOptions={mode:"open"},q[mt("elementProperties")]=new Map,q[mt("finalized")]=new Map,sr?.({ReactiveElement:q}),(Mt.reactiveElementVersions??=[]).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var te=globalThis,ke=s=>s,Tt=te.trustedTypes,Se=Tt?Tt.createPolicy("lit-html",{createHTML:s=>s}):void 0,Re="$lit$",K=`lit$${Math.random().toFixed(9).slice(2)}$`,Pe="?"+K,nr=`<${Pe}>`,et=document,vt=()=>et.createComment(""),bt=s=>s===null||typeof s!="object"&&typeof s!="function",ee=Array.isArray,or=s=>ee(s)||typeof s?.[Symbol.iterator]=="function",Vt=`[ 	
\f\r]`,ft=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ae=/-->/g,Ce=/>/g,L=RegExp(`>|${Vt}(?:([^\\s"'>=/]+)(${Vt}*=${Vt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Me=/'/g,He=/"/g,ze=/^(?:script|style|textarea|title)$/i,ie=s=>(i,...t)=>({_$litType$:s,strings:i,values:t}),a=ie(1),x=ie(2),Hs=ie(3),it=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),Te=new WeakMap,tt=et.createTreeWalker(et,129);function Ee(s,i){if(!ee(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return Se!==void 0?Se.createHTML(i):i}var ar=(s,i)=>{let t=s.length-1,e=[],r,n=i===2?"<svg>":i===3?"<math>":"",o=ft;for(let l=0;l<t;l++){let d=s[l],h,g,f=-1,w=0;for(;w<d.length&&(o.lastIndex=w,g=o.exec(d),g!==null);)w=o.lastIndex,o===ft?g[1]==="!--"?o=Ae:g[1]!==void 0?o=Ce:g[2]!==void 0?(ze.test(g[2])&&(r=RegExp("</"+g[2],"g")),o=L):g[3]!==void 0&&(o=L):o===L?g[0]===">"?(o=r??ft,f=-1):g[1]===void 0?f=-2:(f=o.lastIndex-g[2].length,h=g[1],o=g[3]===void 0?L:g[3]==='"'?He:Me):o===He||o===Me?o=L:o===Ae||o===Ce?o=ft:(o=L,r=void 0);let $=o===L&&s[l+1].startsWith("/>")?" ":"";n+=o===ft?d+nr:f>=0?(e.push(h),d.slice(0,f)+Re+d.slice(f)+K+$):d+K+(f===-2?l:$)}return[Ee(s,n+(s[t]||"<?>")+(i===2?"</svg>":i===3?"</math>":"")),e]},yt=class s{constructor({strings:i,_$litType$:t},e){let r;this.parts=[];let n=0,o=0,l=i.length-1,d=this.parts,[h,g]=ar(i,t);if(this.el=s.createElement(h,e),tt.currentNode=this.el.content,t===2||t===3){let f=this.el.content.firstChild;f.replaceWith(...f.childNodes)}for(;(r=tt.nextNode())!==null&&d.length<l;){if(r.nodeType===1){if(r.hasAttributes())for(let f of r.getAttributeNames())if(f.endsWith(Re)){let w=g[o++],$=r.getAttribute(f).split(K),H=/([.?@])?(.*)/.exec(w);d.push({type:1,index:n,name:H[2],strings:$,ctor:H[1]==="."?Zt:H[1]==="?"?Jt:H[1]==="@"?Qt:ot}),r.removeAttribute(f)}else f.startsWith(K)&&(d.push({type:6,index:n}),r.removeAttribute(f));if(ze.test(r.tagName)){let f=r.textContent.split(K),w=f.length-1;if(w>0){r.textContent=Tt?Tt.emptyScript:"";for(let $=0;$<w;$++)r.append(f[$],vt()),tt.nextNode(),d.push({type:2,index:++n});r.append(f[w],vt())}}}else if(r.nodeType===8)if(r.data===Pe)d.push({type:2,index:n});else{let f=-1;for(;(f=r.data.indexOf(K,f+1))!==-1;)d.push({type:7,index:n}),f+=K.length-1}n++}}static createElement(i,t){let e=et.createElement("template");return e.innerHTML=i,e}};function nt(s,i,t=s,e){if(i===it)return i;let r=e!==void 0?t._$Co?.[e]:t._$Cl,n=bt(i)?void 0:i._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),n===void 0?r=void 0:(r=new n(s),r._$AT(s,t,e)),e!==void 0?(t._$Co??=[])[e]=r:t._$Cl=r),r!==void 0&&(i=nt(s,r._$AS(s,i.values),r,e)),i}var Xt=class{constructor(i,t){this._$AV=[],this._$AN=void 0,this._$AD=i,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(i){let{el:{content:t},parts:e}=this._$AD,r=(i?.creationScope??et).importNode(t,!0);tt.currentNode=r;let n=tt.nextNode(),o=0,l=0,d=e[0];for(;d!==void 0;){if(o===d.index){let h;d.type===2?h=new xt(n,n.nextSibling,this,i):d.type===1?h=new d.ctor(n,d.name,d.strings,this,i):d.type===6&&(h=new Lt(n,this,i)),this._$AV.push(h),d=e[++l]}o!==d?.index&&(n=tt.nextNode(),o++)}return tt.currentNode=et,r}p(i){let t=0;for(let e of this._$AV)e!==void 0&&(e.strings!==void 0?(e._$AI(i,e,t),t+=e.strings.length-2):e._$AI(i[t])),t++}},xt=class s{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(i,t,e,r){this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=i,this._$AB=t,this._$AM=e,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let i=this._$AA.parentNode,t=this._$AM;return t!==void 0&&i?.nodeType===11&&(i=t.parentNode),i}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(i,t=this){i=nt(this,i,t),bt(i)?i===p||i==null||i===""?(this._$AH!==p&&this._$AR(),this._$AH=p):i!==this._$AH&&i!==it&&this._(i):i._$litType$!==void 0?this.$(i):i.nodeType!==void 0?this.T(i):or(i)?this.k(i):this._(i)}O(i){return this._$AA.parentNode.insertBefore(i,this._$AB)}T(i){this._$AH!==i&&(this._$AR(),this._$AH=this.O(i))}_(i){this._$AH!==p&&bt(this._$AH)?this._$AA.nextSibling.data=i:this.T(et.createTextNode(i)),this._$AH=i}$(i){let{values:t,_$litType$:e}=i,r=typeof e=="number"?this._$AC(i):(e.el===void 0&&(e.el=yt.createElement(Ee(e.h,e.h[0]),this.options)),e);if(this._$AH?._$AD===r)this._$AH.p(t);else{let n=new Xt(r,this),o=n.u(this.options);n.p(t),this.T(o),this._$AH=n}}_$AC(i){let t=Te.get(i.strings);return t===void 0&&Te.set(i.strings,t=new yt(i)),t}k(i){ee(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,e,r=0;for(let n of i)r===t.length?t.push(e=new s(this.O(vt()),this.O(vt()),this,this.options)):e=t[r],e._$AI(n),r++;r<t.length&&(this._$AR(e&&e._$AB.nextSibling,r),t.length=r)}_$AR(i=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);i!==this._$AB;){let e=ke(i).nextSibling;ke(i).remove(),i=e}}setConnected(i){this._$AM===void 0&&(this._$Cv=i,this._$AP?.(i))}},ot=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(i,t,e,r,n){this.type=1,this._$AH=p,this._$AN=void 0,this.element=i,this.name=t,this._$AM=r,this.options=n,e.length>2||e[0]!==""||e[1]!==""?(this._$AH=Array(e.length-1).fill(new String),this.strings=e):this._$AH=p}_$AI(i,t=this,e,r){let n=this.strings,o=!1;if(n===void 0)i=nt(this,i,t,0),o=!bt(i)||i!==this._$AH&&i!==it,o&&(this._$AH=i);else{let l=i,d,h;for(i=n[0],d=0;d<n.length-1;d++)h=nt(this,l[e+d],t,d),h===it&&(h=this._$AH[d]),o||=!bt(h)||h!==this._$AH[d],h===p?i=p:i!==p&&(i+=(h??"")+n[d+1]),this._$AH[d]=h}o&&!r&&this.j(i)}j(i){i===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,i??"")}},Zt=class extends ot{constructor(){super(...arguments),this.type=3}j(i){this.element[this.name]=i===p?void 0:i}},Jt=class extends ot{constructor(){super(...arguments),this.type=4}j(i){this.element.toggleAttribute(this.name,!!i&&i!==p)}},Qt=class extends ot{constructor(i,t,e,r,n){super(i,t,e,r,n),this.type=5}_$AI(i,t=this){if((i=nt(this,i,t,0)??p)===it)return;let e=this._$AH,r=i===p&&e!==p||i.capture!==e.capture||i.once!==e.once||i.passive!==e.passive,n=i!==p&&(e===p||r);r&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,i),this._$AH=i}handleEvent(i){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,i):this._$AH.handleEvent(i)}},Lt=class{constructor(i,t,e){this.element=i,this.type=6,this._$AN=void 0,this._$AM=t,this.options=e}get _$AU(){return this._$AM._$AU}_$AI(i){nt(this,i)}};var lr=te.litHtmlPolyfillSupport;lr?.(yt,xt),(te.litHtmlVersions??=[]).push("3.3.3");var Oe=(s,i,t)=>{let e=t?.renderBefore??i,r=e._$litPart$;if(r===void 0){let n=t?.renderBefore??null;e._$litPart$=r=new xt(i.insertBefore(vt(),n),n,void 0,t??{})}return r._$AI(s),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var re=globalThis,v=class extends q{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let i=super.createRenderRoot();return this.renderOptions.renderBefore??=i.firstChild,i}update(i){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(i),this._$Do=Oe(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return it}};v._$litElement$=!0,v.finalized=!0,re.litElementHydrateSupport?.({LitElement:v});var cr=re.litElementPolyfillSupport;cr?.({LitElement:v});(re.litElementVersions??=[]).push("4.2.2");/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var wt=12,Ne=2.2,O=100,N=100,Ie=500;function Ue(s,i){let t=Array.from({length:wt},(e,r)=>{let n=-90+360/wt*r+Ne/2,o=-90+360/wt*(r+1)-Ne/2;return mr(93,82,n,o)});return x`
    <svg viewBox="0 0 200 200" role="img" aria-label="Echo Dot">
      ...
      ${se(O-46,N,hr(s.muted),s.muted?"Microphone muted":"Microphone live",i.mute,s.muted)}
    </svg>
  `}function se(s,i,t,e,r,n=!1){return x`<g class="btn" data-lit=${String(n)} transform="translate(${s} ${i})"
    role="button" tabindex="0" aria-label=${e} @click=${r}>
    <circle class="face" cx="0" cy="0" r="13"></circle>
    <g class="glyph">${t}</g>
  </g>`}function hr(s){return x`
...
`;var Fe=26,Pt=135,zt=270,_=100,k=100,G=84,Et=38,T=class extends v{constructor(){super(...arguments);this.level="";this.floor="";this.gate="";this.mode="";this.muted=!1;this.held=null;this.grab=t=>{let e=t.currentTarget;e.setPointerCapture(t.pointerId);let r=this.hass.states[this.gate]?.attributes??{},n=r.min??0,o=r.max??20,l=r.step??1,d=this.number(this.floor)??0,h=this.number(this.level)??0,g=Math.max(d+Fe,h+3),f=H=>{let W=e.getBoundingClientRect(),Gi=H.clientX-W.left-W.width/2,Yi=H.clientY-W.top-W.height/2,Gt=Math.atan2(Yi,Gi)*180/Math.PI-Pt;for(;Gt<0;)Gt+=360;let Vi=ne(Math.min(Gt,zt)/zt);return Math.max(n,Math.min(o,Math.round(Vi*(g-d)/l)*l))},w=H=>{this.held=f(H)},$=H=>{e.removeEventListener("pointermove",w),e.removeEventListener("pointerup",$),e.removeEventListener("pointercancel",$);let W=f(H);this.held=null,this.hass.callService("number","set_value",{entity_id:this.gate,value:W})};e.addEventListener("pointermove",w),e.addEventListener("pointerup",$),e.addEventListener("pointercancel",$),this.held=f(t)}}render(){let t=this.number(this.level),e=this.number(this.floor),r=this.held??this.number(this.gate);if(t===null||e===null||r===null)return p;let n=this.hass.states[this.mode],o=We(n?.state),l=Math.max(e+Fe,t+3),d=ne((t-e)/(l-e)),h=ne(r/(l-e)),g=t>=e+r&&!this.muted;return a`
      <div class="dial" @pointerdown=${this.grab}>
        <svg viewBox="0 0 200 200" role="img" aria-label="Microphone array">
          ...
          ${this.muted?p:x`<path
              ...
              ></path>`}
          ${this.muted?p:wr(h)} ${o==="beam"?xr():p}
          ${o==="sum"?yr():p} ${vr(o,this.muted)}
      ...
      <div class="side">
        ...
        <div class="modes">
          ${(n?.attributes.options??[]).map(f=>a`<button
            ...
            >
              <svg viewBox="0 0 40 40">${br(We(f))}</svg>
              <span>${f}</span>
            </button>`)}
        </div>
    ...
    `}number(t){let e=Number(this.hass?.states?.[t]?.state);return Number.isFinite(e)?e:null}};T.styles=b(je),c([u({attribute:!1})],T.prototype,"hass",2),c([u()],T.prototype,"level",2),c([u()],T.prototype,"floor",2),c([u()],T.prototype,"gate",2),c([u()],T.prototype,"mode",2),c([u({type:Boolean})],T.prototype,"muted",2),c([m()],T.prototype,"held",2),T=c([y("echolocal-array")],T);function We(s){let i=(s??"").toLowerCase();return i.includes("center")||i.includes("centre")?"one":i.includes("beam")?"beam":"sum"}function vr(s,i){return[[_,k],...Array.from({length:6},(e,r)=>{let n=(-90+r*60)*Math.PI/180;return[_+Et*Math.cos(n),k+Et*Math.sin(n)]})].map(([e,r],n)=>x`<circle class="capsule" data-on=${String(!i&&(s!=="one"||n===0))}
      cx=${e.toFixed(1)} cy=${r.toFixed(1)} r=${n===0?7:5.5}></circle>`)}function br(s){let i=[[20,20],...Array.from({length:6},(t,e)=>{let r=(-90+e*60)*Math.PI/180;return[20+12*Math.cos(r),20+12*Math.sin(r)]})];return x`
    ...
    ${i.map(([t,e],r)=>x`<circle class="capsule" data-on=${String(s!=="one"||r===0)}
          cx=${t.toFixed(1)} cy=${e.toFixed(1)} r=${r===0?3.4:2.6}></circle>`)}`}function yr(){return Array.from({length:6},(s,i)=>{let t=(-90+i*60)*Math.PI/180;return x`<line class="spoke" x1=${_} y1=${k}
      x2=${(_+Et*Math.cos(t)).toFixed(1)} y2=${(k+Et*Math.sin(t)).toFixed(1)}></line>`})}function xr(){return x`<path class="beam" d="M${_} ${k}C${_-34} ${k-30} ${_-24} ${k-66} ${_} ${k-66}C${_+24} ${k-66} ${_+34} ${k-30} ${_} ${k}Z"></path>`}function qe(){let s=Pt*Math.PI/180,i=(Pt+zt)*Math.PI/180;return`M${(_+G*Math.cos(s)).toFixed(2)} ${(k+G*Math.sin(s)).toFixed(2)}
    A${G} ${G} 0 1 1 ${(_+G*Math.cos(i)).toFixed(2)} ${(k+G*Math.sin(i)).toFixed(2)}`}function wr(s){let i=(Pt+s*zt)*Math.PI/180,t=G-8,e=G+8;return x`<line class="notch"
    x1=${(_+t*Math.cos(i)).toFixed(1)} y1=${(k+t*Math.sin(i)).toFixed(1)}
    x2=${(_+e*Math.cos(i)).toFixed(1)} y2=${(k+e*Math.sin(i)).toFixed(1)}></line>`}function ne(s){return Math.max(0,Math.min(1,s))}var Be=`:host{display:inline-flex;flex:0 0 auto;vertical-align:middle}button{width:15px;height:15px;display:grid;place-items:center;padding:0;border:1px solid color-mix(in srgb,var(--primary-text-color) 26%,transparent);border-radius:50%;background:none;color:var(--secondary-text-color);font:inherit;font-size:9px;font-weight:700;line-height:1;cursor:help;opacity:.65}button:hover{opacity:1;color:var(--primary-color);border-color:var(--primary-color)}ha-tooltip{--max-width: min(300px, 70vw);--ha-tooltip-font-size: .79rem;--ha-tooltip-font-weight: 400;--ha-tooltip-line-height: 1.45;--ha-tooltip-padding: 11px 13px;--ha-tooltip-border-radius: 11px}
`;var _r=0,at=class extends v{constructor(){super(...arguments);this.text="";this.anchor=`ask-${++_r}`}render(){return this.text?a`
      ...
      <div class="hue">
        ...
        <div class="swatches">
          ${Nt.map(([o,l])=>a`<button
              ...
              title=${o}
              aria-label=${o}
              data-on=${String(Cr(t.attributes.rgb_color,l))}
...
`;var dt=null,jr=5*6e4,M=class extends v{constructor(){super(...arguments);this.device="";this.turn="";this.filename="recording.wav";this.at=0;this.busy=!1;this.playing=!1;this.gone=!1;this.play=async()=>{if(this.playing){dt?.audio.pause();return}let t=await this.fetch();if(!t)return;dt?.stop();let e=new Audio(t),r=()=>{this.playing=!1,dt?.audio===e&&(dt=null)};e.addEventListener("ended",r),e.addEventListener("pause",r),dt={audio:e,stop:()=>e.pause()},this.playing=!0,e.play().catch(r)};this.save=async()=>{let t=await this.fetch();if(!t)return;let e=document.createElement("a");e.href=t,e.download=this.filename,e.click()}}disconnectedCallback(){super.disconnectedCallback(),this.playing&&dt?.audio.pause()}updated(){if(!this.hass||!this.turn||this.checkedTurn===this.turn)return;if(this.checkedTurn=this.turn,this.present=void 0,this.gone=!1,this.at&&Date.now()-this.at<jr){this.present=!0;return}let t=this.device?$t(this.hass,this.device,Qe):void 0;t&&si(this.hass,t).then(e=>{this.checkedTurn===this.turn&&(this.present=e.has(this.turn))})}render(){return!this.turn||!this.action()||this.present!==!0?p:this.gone?a`<span class="gone" title="The device no longer has this recording">
    ...
    `}action(){return this.device?$t(this.hass,this.device,Je):void 0}async fetch(){let t=ri(this.turn);if(t)return t;let e=this.action();if(!e)return null;this.busy=!0;try{let r=await ni(this.hass,e,this.turn);return this.gone=!r,r||this.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:"That recording is no longer on the device."},bubbles:!0,composed:!0})),r}finally{this.busy=!1}}};M.styles=b(oi),c([u({attribute:!1})],M.prototype,"hass",2),c([u()],M.prototype,"device",2),c([u()],M.prototype,"turn",2),c([u()],M.prototype,"filename",2),c([u({type:Number})],M.prototype,"at",2),c([m()],M.prototype,"busy",2),c([m()],M.prototype,"playing",2),c([m()],M.prototype,"present",2),c([m()],M.prototype,"gone",2),M=c([y("echolocal-recording")],M);var Fr=14,z=class extends v{constructor(){super(...arguments);this.device="";this.deviceId="";this.live=[];this.asked=!1;this.loading=!0}updated(){this.asked||!this.hass||!this.deviceId||(this.asked=!0,this.listen())}disconnectedCallback(){super.disconnectedCallback(),this.stop?.()}render(){let t=this.merged(),e=t.some(r=>r.turn&&lt(r.turn).length>0);return a`
      <div class="caption">
        Recent turns
    ...
    `}scale(t){return Math.max(1,...t.map(e=>e.turn?ct(e.turn):0))}row(t,e){let r=t.turn,n=r?lt(r):[],o=r?ct(r):0;return a`<div class="turn">
      <div class="when">${Wr(t.at)}</div>
    ...
    </div>`}merged(){return[...this.live].sort((t,e)=>e.at-t.at)}async listen(){let t=new Date(Date.now()-Fr*864e5),e=this.deviceId?[this.deviceId]:[];try{this.stop=await It(this.hass,t,e,r=>{this.loading=!1,r.length&&(this.live=[...r.map(({at:n,turn:o})=>({at:n,wake:o.wake_word,heard:o.heard,reply:o.reply,turn:o})),...this.live])})}catch{this.loading=!1}}};z.styles=b(ei),c([u({attribute:!1})],z.prototype,"hass",2),c([u()],z.prototype,"device",2),c([u()],z.prototype,"deviceId",2),c([m()],z.prototype,"live",2),c([m()],z.prototype,"asked",2),c([m()],z.prototype,"loading",2),z=c([y("echolocal-history")],z);function Wr(s){return new Date(s).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"})}function qr(s){let i=new Date(s.at).toISOString().replace(/[:.]/g,"-").slice(0,19),t=s.wake.toLowerCase().replace(/[^a-z0-9]+/g,"-");return`${i}-${t}.wav`}var ai=`:host{display:flex}button{display:flex;align-items:center;gap:8px;padding:8px 14px;border:1px solid color-mix(in srgb,var(--primary-text-color) 18%,transparent);border-radius:999px;background:color-mix(in srgb,var(--primary-text-color) 5%,transparent);color:var(--primary-text-color);font:inherit;cursor:pointer}button[disabled]{cursor:default;opacity:.6}button ha-icon{--mdc-icon-size: 18px;color:var(--secondary-text-color);display:flex}.failed{color:var(--error-color, #db4437)}
`;var Kr=64,B=class extends v{constructor(){super(...arguments);this.device="";this.busy=!1;this.failed=!1;this.save=async()=>{let t=this.action();if(t){this.busy=!0,this.failed=!1;try{let e=await this.read(t);if(!e){this.failed=!0;return}Yr(`${this.device}_logs_${Gr()}.txt`,e.join(`
`)+`
...
`;var le=135,ce=270,Ut=100,Dt=100,pt=78,Zr={White:"mdi:grain",Pink:"mdi:blur",Brown:"mdi:waveform",Rain:"mdi:weather-pouring",Ocean:"mdi:waves",Brook:"mdi:water",Wind:"mdi:weather-windy",Fire:"mdi:fireplace",Crickets:"mdi:bug-outline",Fan:"mdi:fan",Cabin:"mdi:airplane"},ht="None",Y=class extends v{constructor(){super(...arguments);this.player="";this.jack="";this.grab=t=>{let e=t.currentTarget;e.setPointerCapture(t.pointerId);let r=d=>{let h=e.getBoundingClientRect(),g=d.clientX-h.left-h.width/2,f=d.clientY-h.top-h.height/2,w=Math.atan2(f,g)*180/Math.PI-le;for(;w<0;)w+=360;let $=Math.max(0,Math.min(1,Math.min(w,ce)/ce));return Math.round($*30)/30},n=d=>this.hass.callService("media_player","volume_set",{entity_id:this.player,volume_level:r(d)}),o=d=>n(d),l=d=>{e.removeEventListener("pointermove",o),e.removeEventListener("pointerup",l),e.removeEventListener("pointercancel",l),n(d)};e.addEventListener("pointermove",o),e.addEventListener("pointerup",l),e.addEventListener("pointercancel",l),n(t)}}render(){let t=this.hass.states[this.player];if(!t)return p;let e=Number(t.attributes.volume_level??0),r=t.attributes.is_volume_muted===!0,n=this.jack?this.hass.states[this.jack]?.state==="on":!1;return a`
    ...
    `}};Y.styles=b(ci),c([u({attribute:!1})],Y.prototype,"hass",2),c([u()],Y.prototype,"player",2),c([u()],Y.prototype,"jack",2),Y=c([y("echolocal-volume")],Y);var V=class extends v{constructor(){super(...arguments);this.layers=[];this.busy=!1}render(){let t=this.layers.map(o=>this.hass.states[o]?.state??ht),e=(this.hass.states[this.layers[0]]?.attributes.options??[]).filter(o=>o!==ht),r=t.every(o=>o!==ht),n=o=>t.indexOf(o);return a`
      <div class="caption">
        Generated sound
        <span>${r?"Both layers in use":`${t.filter(o=>o!==ht).length} of 2`}</span>
      </div>
      <div class="grid">
    ...
    >
      Run
        ...
        ${r?a`<span class="unit">${r}</span>`:p}`})}tile({entityId:t,label:e,name:r},n,o){let l=this.hass.states[t].attributes.icon,d=n&&l?.includes("mic")&&l.includes("off"),h=this.help?Ye(r):void 0;return a`<div class="tile" data-active=${String(n&&!d)} data-alert=${String(!!d)}>
      <div class="top">
      ...
      ${o.under??p}
    </div>`}moreInfo(t){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:t},bubbles:!0,composed:!0}))}dismiss(){this.dispatchEvent(new CustomEvent("closed",{bubbles:!0,composed:!0}))}};A.styles=[b(Ot),b(Ke)],c([u({attribute:!1})],A.prototype,"hass",2),c([u()],A.prototype,"heading",2),c([u()],A.prototype,"subtitle",2),c([u()],A.prototype,"icon",2),c([u({attribute:!1})],A.prototype,"sections",2),c([u({attribute:!1})],A.prototype,"widgets",2),c([u()],A.prototype,"device",2),c([u()],A.prototype,"deviceId",2),c([u({type:Boolean})],A.prototype,"help",2),c([u()],A.prototype,"about",2),c([m()],A.prototype,"held",2),A=c([y("echolocal-dialog")],A);function hi(s,i){let t=de(s);return i.map(e=>{let r=t?.get(e.entity_id);return{...e,name:r?.name??"",slot:r?.slot??0}})}function jt(s){let i=new Map;for(let t of s){let e=i.get(t.name);e?e.push(t):i.set(t.name,[t])}for(let t of i.values())t.sort((e,r)=>e.slot-r.slot);return i}var rt="echolocal-keys",pi=!1,ui=null;function de(s){return pi||(pi=!0,Qr(s)),ui}function Qr(s){s.connection?.subscribeMessage(i=>{let t=new Map;for(let e of i.entities)e.device_id&&t.set(e.entity_id,{entityId:e.entity_id,deviceId:e.device_id,...Lr(e.object_id),disabled:e.disabled});ui=t,window.dispatchEvent(new Event(rt))},{type:"echolocal/entities"}).catch(()=>{})}function Lr(s){let i=s.lastIndexOf("_"),t=i<0?"":s.slice(i+1);return/^\d+$/.test(t)?{name:s.slice(0,i),slot:Number(t)}:{name:s,slot:0}}var Wt={ring:[{title:null,rows:[["ring","Ring"]]},{title:"Segments",rows:[["segment","Segment"]]}],microphone:[{title:null,rows:[["mic_mute","Mute"]]},{title:"Capture",rows:[["microphone_gain","Gain"],["microphone_mixing","Mixing"],["microphone_leveling","Leveling"],["microphone_cancel_echo","Echo cancellation"],["microphone_noise_reduction","Noise reduction"]]},{title:"The room",rows:[["microphone_sensitivity","Sensitivity"],["room_level","Room level"],["room_floor","Room floor"],["stop_word_sensitivity","Stop word"],["vad_sensitivity","End of speech"]]},{title:"Indicator",rows:[["mute_led_brightness","Mute light"]]}],playback:[{title:null,rows:[["headphones","Headphones"]]},{title:"Generated sound",rows:[["noise_layer","Layer"]]},{title:"During a turn",rows:[["media_on_turn","Music"],["media_duck_level","Ducking"]]},{title:"Voice",rows:[["voice_resampling","Resampling"]]}],assistant:[{title:null,rows:[["wake_word","Wake word"],["pipeline","Pipeline"],["wake_threshold","Wake sensitivity"]]},{title:"Timing",rows:[["max_listen","Max listen"],["max_think","Max think"],["follow_up","Follow up"]]},{title:"Feedback",rows:[["wake_effect","Listening effect"],["thinking_effect","Thinking effect"],["replying_effect","Replying effect"],["wake_tone","Chime"]]},{title:"Reply",rows:[["reply_buffer","Buffer"],["reply_delivery","Delivery"]]},{title:"Recordings",rows:[["keep_recordings","Recordings kept"]]}],device:[{title:null,rows:[["firmware","Firmware"],["update_channel","Update channel"],["check_for_updates","Check for updates"]]},{title:"Bluetooth",rows:[["bluetooth_proxy","Proxy enabled"]]},{title:"Maintenance",rows:[["metrics_interval","Metrics interval"],["purge_cache","Purge cache","cached_data"],["test_playback","Test playback"],["remote_adb","Remote adb"],["insecure_tls","Insecure TLS"]]}],diagnostics:[{title:"Network",rows:[["ip_address","IP address"],["wifi_signal","Signal"],["wifi_sent","Sent"],["wifi_received","Received"],["ble_advertisements","Bluetooth advertisements"]]},{title:"Hardware",rows:[["cpu_temperature","CPU"],["radio_temperature","Radio"],["cpu_cores","Cores"],["cpu_cores_online","Cores online"],["load_average","Load"],["memory_available","Memory"],["free_space","Disk"]]},{title:"Updates",rows:[["update_status","Update status"],["update_outcome","Last update"]]}]},ts={ring:[{widget:"power",place:"header",roles:{light:"ring"}},{widget:"appearance",roles:{light:"ring"},lists:{segments:"segment",muted:"ring_muted",failure:"failure_effect",room:"room_reaction"}}],playback:[{widget:"player",place:"header",roles:{player:"speaker"}},{widget:"volume",roles:{player:"speaker"},lists:{jack:"headphones"}},{widget:"noise",roles:{first:"noise_layer"},lists:{layers:"noise_layer"}}],activity:[{widget:"history",roles:{}}],microphone:[{widget:"mute",place:"header",roles:{mute:"mic_mute",lamp:"mute_led_brightness"}},{widget:"array",roles:{level:"room_level",floor:"room_floor",gate:"microphone_sensitivity",mode:"microphone_mixing"}}]},es=[["ring","ring"],["microphone","mic_mute"],["playback","speaker"]];function mi(s){let i=es.filter(([,t])=>s.by.has(t)).map(([t])=>({kind:t,slot:0}));for(let t of s.by.get("wake_threshold")??[])i.push({kind:"assistant",slot:t.slot});return i}function gi(s,i,t=0){let e=[],r=new Set;for(let n of ts[s]??[]){let o={};for(let[d,h]of Object.entries(n.roles)){let g=Ft(i.by,h,t)[0];g&&(o[d]=g.entity_id)}if(Object.keys(o).length!==Object.keys(n.roles).length)continue;let l={};for(let[d,h]of Object.entries(n.lists??{}))l[d]=Ft(i.by,h,t).map(g=>g.entity_id);e.push({widget:n.widget,place:n.place??"body",roles:o,lists:l}),[...Object.values(o),...Object.values(l).flat()].forEach(d=>r.add(d))}return{widgets:e,sections:bi(Wt[s]??[],i.by,t,r)}}var is=new Set(["switch","select","number","button","text","time","update"]);function fi(s){return yi(Wt.device??[],s.entities.filter(i=>i.device_id===s.device.id&&is.has(i.entity_id.split(".")[0])),new Set,i=>i.entity_category!=="diagnostic")}function vi(s){let i=s.entities.filter(t=>t.entity_category==="diagnostic");return{widgets:[{widget:"logs",roles:{},lists:{}}],sections:yi(Wt.diagnostics??[],i,new Set)}}function Ft(s,i,t){let e=s.get(i)??[];return t?e.filter(r=>(r.slot||1)===t):e}function bi(s,i,t,e){let r=[];for(let n of s){let o=[];for(let[l,d,h]of n.rows){let g=Ft(i,l,t);for(let f of g)e.has(f.entity_id)||o.push({entityId:f.entity_id,name:l,label:g.length>1?`${d} ${f.slot}`:d,reading:h?Ft(i,h,t)[0]?.entity_id:void 0})}o.length&&r.push({title:n.title,rows:o})}return r}var rs=new Set(Object.values(Wt).flatMap(s=>(s??[]).flatMap(i=>i.rows.flatMap(([t,,e])=>e?[t,e]:[t]))));function yi(s,i,t,e=()=>!0){let r=bi(s,jt(i),0,t),n=new Set(r.flatMap(l=>l.rows.flatMap(d=>[d.entityId,d.reading??""]))),o=i.filter(l=>!n.has(l.entity_id)&&!t.has(l.entity_id)&&!rs.has(l.name)&&e(l));return o.length?[...r,{title:r.length?"More":null,rows:o.map(l=>({entityId:l.entity_id,name:l.name,label:l.name||l.entity_id})).sort((l,d)=>l.label.localeCompare(d.label))}]:r}var ss="EchoLocal",ns="esphome",_t=12;function os(s){return!!s?.identifiers?.some(([i])=>i===ns)}function xi(s,i){return Object.values(s.devices??{}).filter(t=>t.via_device_id===i&&!t.disabled_by).sort((t,e)=>S(t).localeCompare(S(e)))}function C(s){return s?Object.values(s.devices??{}).filter(i=>as(s,i.id)&&!i.via_device_id&&!i.disabled_by).sort((i,t)=>S(i).localeCompare(S(t))):[]}function S(s){return s?.name_by_user||s?.name||""}function as(s,i){return s?.devices?.[i]?.manufacturer!==ss?!1:xi(s,i).some(os)}function X(s,i){if(!s||!i)return null;let t=s.devices?.[i];if(!t)return null;let e=new Set([i,...xi(s,i).map(d=>d.id)]),r=hi(s,Object.values(s.entities??{}).filter(d=>d.device_id&&e.has(d.device_id)&&!d.hidden)),n=jt(r),o=d=>n.get(d)?.[0]?.entity_id,l=new Array(_t).fill(void 0);for(let d of n.get("segment")??[]){let h=d.slot-1;h>=0&&h<_t&&(l[h]=d.entity_id)}return{device:t,entities:r,by:n,satellite:o("assist_satellite"),player:o("speaker"),update:o("firmware"),ring:o("ring"),segments:l,mute:o("mic_mute")}}function wi(s){return(s.by.get("wake_assistant")??[]).map(i=>i.entity_id)}function kt(s,i){let t=i?s?.states?.[i]:void 0;return!t||t.state!=="on"?null:{rgb:t.attributes.rgb_color??[255,255,255],level:(t.attributes.brightness??255)/255}}function $i(s,i){return!!i&&s?.states?.[i]?.state==="on"}function _i(s,i){return(i?s?.states?.[i]?.state:void 0)??"unavailable"}function ki(s,i){let t=new Array(_t).fill(void 0),e=de(s);if(!e)return t;let r=new Set(i.entities.map(n=>n.device_id));for(let n of e.values())!n.disabled||n.name!=="segment"||r.has(n.deviceId)&&n.slot>=1&&n.slot<=_t&&(t[n.slot-1]=n.entityId);return t}async function Si(s,i){await s.callWS({type:"config/entity_registry/update",entity_id:i,disabled_by:null})}var ls={device_id:"Device",shell:"Shell",help:"Explain each setting"},st={ring:"mdi:record-circle-outline",microphone:"mdi:microphone",playback:"mdi:speaker",assistant:"mdi:account-voice",device:"mdi:cog-outline",diagnostics:"mdi:stethoscope",activity:"mdi:timeline-text-outline",follow:"mdi:backup-restore",close:"mdi:check"},cs={idle:"Idle",listening:"Listening",processing:"Thinking",responding:"Speaking",playing:"Playing",unavailable:"Unavailable",unknown:"Unknown"},ds=2500;function ps(s){let i=Math.log10(Math.max(s,1))/Math.log10(ds);return Math.min(1,Math.max(0,i))}var E=class extends v{constructor(){super(...arguments);this.opened=null;this.picked=null;this.holding=!1;this.timer=0;this.offering=null;this.again=()=>this.requestUpdate()}static getConfigElement(){return document.createElement("echolocal-satellite-card-editor")}static getStubConfig(t){return{device_id:C(t)[0]?.id??""}}setConfig(t){if(!t?.device_id)throw new Error("Choose an EchoLocal device");this.config={...t}}getCardSize(){return 6}connectedCallback(){super.connectedCallback(),window.addEventListener(rt,this.again)}disconnectedCallback(){window.removeEventListener(rt,this.again),super.disconnectedCallback()}doing(t){let e=_i(this.hass,t.satellite);return e!=="idle"?e:(t.player?this.hass?.states?.[t.player]?.state:void 0)==="playing"?"playing":e}shellFor(t){let e=this.config?.shell;if(e&&e!=="auto")return e;let r=t.by.get("hardware_color")?.[0]?.entity_id,n=r?this.hass.states[r]?.state:void 0;return n==="black"||n==="white"?n:"grey"}lux(t){let e=t.by.get("lux")?.[0]?.entity_id,r=e?Number(this.hass.states[e]?.state):NaN;return Number.isNaN(r)?null:{value:r,lit:ps(r)}}render(){if(!this.hass||!this.config)return p;let t=X(this.hass,this.config.device_id);if(!t)return a`<ha-card><div class="missing">Device not found</div></ha-card>`;let e=this.doing(t);return a`
      <ha-card>
        <div class="frame">
          <div class="art" data-shell=${this.shellFor(t)} data-activity=${e}>
            ${Ue({segments:this.segments(t),glow:this.glow(t),muted:$i(this.hass,t.mute),holding:this.holding,picked:this.picked,divisible:[...t.segments,...this.switchedOff(t)].some(Boolean),lux:this.lux(t)},{ring:()=>this.open({kind:"ring",slot:0}),segment:r=>this.tapped(t,r),action:r=>this.pressed(t,r),mute:()=>this.toggle("switch",t.mute),volume:r=>this.volume(t,r)})}
          </div>
    ...
    `}foot(t,e){return a`<div class="foot">
      <div class="label">
        ...
        <div class="status">${cs[e]??e}</div>
      </div>
      <div class="tail">
        ${this.square(st.activity,"Activity",()=>this.open({kind:"activity",slot:0}))}
        ${this.square(st.device,"Settings",()=>this.open({kind:"device",slot:0}))}
        ${this.square(st.diagnostics,"Diagnostics",()=>this.open({kind:"diagnostics",slot:0}))}
      </div>
    </div>`}tapped(t,e){if(t.segments[e]){this.picked=this.picked===e?null:e;return}if(this.switchedOff(t)[e]){this.offering=e;return}this.open({kind:"ring",slot:0})}switchedOff(t){return ki(this.hass,t)}offer(t,e){let r=this.switchedOff(t),n=async o=>{for(let l of o)l&&await Si(this.hass,l);this.offering=null,this.picked=e};return a`<div class="foot">
      <div class="label">
      ...
      <div class="top">
        ...
        <div class="tail">
          ${this.square(st.follow,"Follow the ring",()=>{this.hass.callService("light","turn_off",{entity_id:e}),this.picked=null})}
          ${this.square(st.close,"Done",()=>this.picked=null)}
        </div>
      </div>
      <div class="swatches">
        ${Nt.map(([r,n])=>a`<button
    ...
    </div>`}segments(t){let e=kt(this.hass,t.ring);return Array.from({length:wt},(r,n)=>{let o=kt(this.hass,t.segments[n])??e;return{fill:o?`rgb(${o.rgb.join(",")})`:"var(--el-ring-off)",opacity:o?.25+.75*o.level:1}})}glow(t){return kt(this.hass,t.ring)||t.segments.some(r=>kt(this.hass,r))?.55:0}side(t){let e=mi(t),r=e.filter(n=>n.kind==="assistant").length>1;return e.map(({kind:n,slot:o})=>this.square(st[n],this.titled(n,o),()=>this.open({kind:n,slot:o}),r&&n==="assistant"?o:null))}titled(t,e){let r={ring:"Ring",microphone:"Microphone",playback:"Playback",assistant:"Assistant",device:"Settings",diagnostics:"Diagnostics",activity:"Activity"}[t];return e?`${r} ${e}`:r}square(t,e,r,n=null){return a`<button class="sq" title=${e} aria-label=${e} @click=${r}>
      <ha-icon .icon=${t}></ha-icon>
      ${n?a`<span class="badge">${n}</span>`:p}
    </button>`}popup(t){if(!this.opened)return p;let{kind:e,slot:r}=this.opened,n,o=[];return e==="device"?n=fi(t):e==="diagnostics"?{widgets:o,sections:n}=vi(t):{widgets:o,sections:n}=gi(e,t,r),a`<echolocal-dialog
      .hass=${this.hass}
    ...
    ></echolocal-dialog>`}open(t){this.opened=t}pressed(t,e){if(e==="down"){this.holding=!1,this.timer=window.setTimeout(()=>this.holding=!0,Ie);return}clearTimeout(this.timer);let r=this.holding;if(this.holding=!1,e==="cancel")return;let n=wi(t),o=n[r&&n.length>1?1:0];o?this.hass.callService("button","press",{entity_id:o}):this.moreInfo(t.satellite)}toggle(t,e){e&&this.hass.callService(t,"toggle",{entity_id:e})}volume(t,e){t.player&&this.hass.callService("media_player",e>0?"volume_up":"volume_down",{entity_id:t.player})}moreInfo(t){t&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:t},bubbles:!0,composed:!0}))}};E.styles=b(De),c([u({attribute:!1})],E.prototype,"hass",2),c([m()],E.prototype,"config",2),c([m()],E.prototype,"opened",2),c([m()],E.prototype,"picked",2),c([m()],E.prototype,"holding",2),c([m()],E.prototype,"offering",2),E=c([y("echolocal-satellite-card")],E);var ut=class extends v{setConfig(i){this.config={...i}}render(){if(!this.hass||!this.config)return p;let i=[{name:"device_id",required:!0,selector:{select:{mode:"dropdown",options:C(this.hass).map(t=>({value:t.id,label:S(t)}))}}},{name:"shell",selector:{select:{mode:"dropdown",options:[{value:"auto",label:"Auto (from device)"},{value:"black",label:"Black"},{value:"white",label:"White"},{value:"grey",label:"Grey"}]}}},{name:"help",selector:{boolean:{}}}];return a`<ha-form
      .hass=${this.hass}
      .data=${{help:!0,shell:"auto",...this.config}}
      .schema=${i}
      .computeLabel=${t=>ls[t.name]??t.name}
      @value-changed=${t=>this.emit(t.detail.value)}
    ></ha-form>`}emit(i){this.config={...this.config,...i},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this.config},bubbles:!0,composed:!0}))}};c([u({attribute:!1})],ut.prototype,"hass",2),c([m()],ut.prototype,"config",2),ut=c([y("echolocal-satellite-card-editor")],ut);var pe=[];function I(s){pe.push(s),pe.sort((i,t)=>i.order-t.order||i.title.localeCompare(t.title))}function ue(s){return pe.filter(i=>s||!i.admin)}function Ai(s,i){let t=he(s),e=ue(i);return e.find(r=>r.path===t)??e[0]}function Ci(s,i){let t=i?`${s}/${i}`:s;location.pathname!==t&&history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed",{detail:{replace:!1}}))}function me(s,i){if(i!==void 0)return he(i);let t=location.pathname;return he(t.startsWith(s)?t.slice(s.length):"")}function he(s){return s.replace(/^\/+|\/+$/g,"")}var Mi=`:host{display:block;height:100%;overflow:auto;background:var(--primary-background-color);color:var(--primary-text-color)}header{position:sticky;top:0;z-index:2;background:var(--primary-background-color);border-bottom:1px solid color-mix(in srgb,var(--primary-text-color) 10%,transparent)}.bar{max-width:1280px;margin:0 auto;padding:0 16px;display:flex;gap:4px;overflow-x:auto;scrollbar-width:none}.bar::-webkit-scrollbar{display:none}button{display:flex;align-items:center;gap:7px;flex:0 0 auto;padding:14px 14px 12px;border:none;border-bottom:2px solid transparent;background:none;color:var(--secondary-text-color);font:inherit;font-size:.88rem;cursor:pointer}button:hover{color:var(--primary-text-color)}button[data-here=true]{color:var(--primary-color);border-bottom-color:var(--primary-color)}button ha-icon{--mdc-icon-size: 19px;display:flex}.page{max-width:1280px;margin:0 auto;padding:20px 16px 48px;box-sizing:border-box}@media(max-width:600px){button span{display:none}button{padding:14px 16px 12px}}
`;var ge="";async function qt(s){try{return await s.callWS({type:"config/label_registry/list"})??[]}catch{return[]}}function Bt(s,i){let t=new Map,e=[];for(let n of s){let o=n.labels??[];if(!o.length){e.push(n);continue}for(let l of o){let d=i.find(g=>g.label_id===l),h=t.get(l);h?h.devices.push(n):t.set(l,{id:l,name:d?.name??l,icon:d?.icon,devices:[n]})}}let r=[...t.values()].sort((n,o)=>n.name.localeCompare(o.name));return e.length&&r.push({id:ge,name:"Ungrouped",devices:e}),r}async function Hi(s,i){try{return await s.callWS({type:"config/label_registry/create",name:i})}catch{return null}}async function Ti(s,i,t){await s.callWS({type:"config/label_registry/update",label_id:i,name:t})}async function Ri(s,i){await s.callWS({type:"config/label_registry/delete",label_id:i})}async function Pi(s,i,t){await s.callWS({type:"config/device_registry/update",device_id:i,labels:[...new Set(t)]})}async function zi(s,i,t,e){let r=0,n=0,o=0;return await Promise.all(i.map(async l=>{let d=Ei(s,l,t);if(!d){o+=1;return}try{await e(d),r+=1}catch{n+=1}})),{done:r,failed:n,missing:o}}function Kt(s,i,t){let e=i.map(n=>Ei(s,n,t)).filter(n=>!!n),r=[...new Set(e.map(n=>s.states[n]?.state).filter(Boolean))];return{value:r.length===1?r[0]:null,mixed:r.length>1,entities:e}}function Ei(s,i,t){return X(s,i.id)?.by.get(t)?.[0]?.entity_id}var Oi=`:host{display:block;margin-bottom:10px}.bar{display:flex;align-items:center;gap:12px;padding:8px 4px 8px 2px;border-bottom:1px solid color-mix(in srgb,var(--primary-text-color) 10%,transparent)}.name{font-size:1.05rem;color:var(--primary-text-color)}.count{font-size:.78rem;color:var(--secondary-text-color)}.spacer{flex:1}button{display:flex;align-items:center;gap:6px;padding:5px 11px;border:1px solid color-mix(in srgb,var(--primary-text-color) 16%,transparent);border-radius:999px;background:none;color:var(--secondary-text-color);font:inherit;font-size:.8rem;cursor:pointer}button:hover{color:var(--primary-text-color);border-color:color-mix(in srgb,var(--primary-text-color) 34%,transparent)}button[data-on=true]{color:var(--primary-color);border-color:color-mix(in srgb,var(--primary-color) 50%,transparent);background:color-mix(in srgb,var(--primary-color) 12%,transparent)}button ha-icon{--mdc-icon-size: 16px;display:flex}.mixed{font-size:.7rem;opacity:.75}
`;var Ni="mic_mute",Ii="ring",Ui="speaker",Z=class extends v{constructor(){super(...arguments);this.said=""}render(){if(!this.hass||!this.group)return p;let t=this.group.devices,e=Kt(this.hass,t,Ni),r=Kt(this.hass,t,Ii);return a`<div class="bar">
      ...
      ${e.entities.length?this.toggle("mdi:microphone-off","Mute all",e,()=>this.write(Ni,"switch",e.value==="on"?"turn_off":"turn_on")):p}
      ${r.entities.length?this.toggle("mdi:lightbulb-outline","Ring",r,()=>this.write(Ii,"light",r.value==="on"?"turn_off":"turn_on")):p}
      ${this.has(Ui)?a`<button title="Stop whatever is playing" @click=${()=>this.write(Ui,"media_player","media_stop")}>
    ...
    </button>`}has(t){return Kt(this.hass,this.group.devices,t).entities.length>0}async write(t,e,r){let{done:n,failed:o,missing:l}=await zi(this.hass,this.group.devices,t,h=>this.hass.callService(e,r,{entity_id:h})),d=o+l;this.said=d?`${n} of ${n+d}`:"",this.said&&setTimeout(()=>this.said="",4e3)}};Z.styles=b(Oi),c([u({attribute:!1})],Z.prototype,"hass",2),c([u({attribute:!1})],Z.prototype,"group",2),c([m()],Z.prototype,"said",2),Z=c([y("echolocal-groupbar")],Z);var Di=`:host{display:block}.group{margin-bottom:26px}.view{display:flex;justify-content:flex-end;margin-bottom:14px}.pair{display:flex;border:1px solid color-mix(in srgb,var(--primary-text-color) 16%,transparent);border-radius:999px;overflow:hidden}.pair button{display:flex;align-items:center;gap:6px;padding:5px 13px;border:none;background:none;color:var(--secondary-text-color);font:inherit;font-size:.8rem;cursor:pointer}.pair button:hover{color:var(--primary-text-color)}.pair button[data-on=true]{color:var(--primary-color);background:color-mix(in srgb,var(--primary-color) 14%,transparent)}.pair button ha-icon{--mdc-icon-size: 16px;display:flex}.grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(340px,1fr));gap:16px;align-items:start}.empty{color:var(--secondary-text-color);max-width:46ch;line-height:1.5}
`;I({path:"",title:"Home",icon:"mdi:view-grid-outline",element:"echolocal-home",order:0});var ji="echolocal:home:grouped",U=class extends v{constructor(){super(...arguments);this.narrow=!1;this.known=[];this.asked=!1;this.grouped=localStorage.getItem(ji)!=="no";this.cards=new Map}updated(){this.asked||!this.hass||(this.asked=!0,this.load())}render(){if(!this.hass)return p;let t=C(this.hass);if(!t.length)return a`<div class="empty">
        No EchoLocal devices yet. One appears here once Home Assistant has adopted it over the ESPHome
        integration.
      </div>`;let e=Bt(t,this.known),r=e.some(o=>o.id!==ge),n=this.grouped&&r?e:[{id:"all",name:"All devices",devices:t}];return a`
      ${r?a`<div class="view">
            <div class="pair">
    ...
    `}button(t,e,r){return a`<button
      ...
      @click=${()=>{this.grouped=t,localStorage.setItem(ji,t?"yes":"no")}}
    >
    ...
    </div>`}card(t,e){let r=`${t}/${e}`,n=this.cards.get(r);return n||(n=document.createElement("echolocal-satellite-card"),n.setConfig({device_id:e}),this.cards.set(r,n)),n.hass=this.hass,n}async load(){this.known=await qt(this.hass)}};U.styles=b(Di),c([u({attribute:!1})],U.prototype,"hass",2),c([u({type:Boolean})],U.prototype,"narrow",2),c([m()],U.prototype,"known",2),c([m()],U.prototype,"asked",2),c([m()],U.prototype,"grouped",2),U=c([y("echolocal-home")],U);var Fi=`:host{display:block}.make{display:flex;gap:8px;margin-bottom:20px}ha-input.new{flex:1;max-width:280px}table{width:100%;border-collapse:collapse;font-size:.9rem}th{padding:8px 10px;text-align:center;font-weight:600;font-size:.72rem;text-transform:uppercase;letter-spacing:.07em;color:var(--secondary-text-color);white-space:nowrap}th.who{text-align:left}th .label{display:flex;align-items:center;justify-content:center;gap:4px}th ha-input{--ha-input-text-align: center}th ha-icon-button{--mdc-icon-size: 15px;color:var(--secondary-text-color)}th ha-icon-button:hover{color:var(--error-color, #db4437)}td{padding:10px;border-top:1px solid color-mix(in srgb,var(--primary-text-color) 10%,transparent);text-align:center}td.who{text-align:left;color:var(--primary-text-color)}.none{color:var(--secondary-text-color);max-width:52ch;line-height:1.5}
`;I({path:"groups",title:"Groups",icon:"mdi:group",element:"echolocal-groups",order:30,admin:!0});var D=class extends v{constructor(){super(...arguments);this.known=[];this.asked=!1;this.naming="";this.busy=!1}connectedCallback(){super.connectedCallback(),this.hass?.connection?.subscribeEvents(()=>this.load(),"label_registry_updated").then(t=>this.stop=t).catch(()=>{})}disconnectedCallback(){super.disconnectedCallback(),this.stop?.()}updated(){this.asked||!this.hass||(this.asked=!0,this.load())}render(){if(!this.hass)return p;let t=C(this.hass),e=this.known;return a`
    ...
    `}head(t){let e=Bt(C(this.hass),this.known).find(r=>r.id===t.label_id)?.devices.length;return a`<th>
      <div class="label">
        <ha-input
          .value=${t.name}
...
`;I({path:"activity",title:"Activity",icon:"mdi:timeline-text-outline",element:"echolocal-activity",order:20});var vs=14,j=class extends v{constructor(){super(...arguments);this.seen=[];this.only="";this.asked=!1;this.loading=!0}updated(){this.asked||!this.hass||(this.asked=!0,this.listen())}disconnectedCallback(){super.disconnectedCallback(),this.stop?.()}render(){if(!this.hass)return p;let t=this.names(),e=this.only?this.seen.filter(n=>n.turn.device===this.only):this.seen,r=Math.max(1,...e.map(n=>ct(n.turn)));return a`
    ...
    `}row(t,e,r){let n=lt(t.turn),o=ct(t.turn),l=t.turn.outcome!=="completed",d=e[t.turn.device],h=d?.label??"elsewhere";return a`<div class="turn">
      <div class="when">${ys(t.at)}</div>
      <div class="who">${h}</div>
      <div class="content">
    ...
    </div>`}names(){let t={};for(let e of C(this.hass))t[e.id]={label:S(e),node:e.name??""};return t}async listen(){let t=new Date(Date.now()-vs*864e5),e=C(this.hass).map(r=>r.id);if(!e.length){this.asked=!1;return}try{this.stop=await It(this.hass,t,e,r=>{this.loading=!1,r.length&&(this.seen=[...r,...this.seen].sort((n,o)=>o.at-n.at))})}catch{this.loading=!1}}};j.styles=b(Wi),c([u({attribute:!1})],j.prototype,"hass",2),c([m()],j.prototype,"seen",2),c([m()],j.prototype,"only",2),c([m()],j.prototype,"asked",2),c([m()],j.prototype,"loading",2),j=c([y("echolocal-activity")],j);function bs(s,i){let t=new Date(s.at).toISOString().replace(/[:.]/g,"-").slice(0,19),e=r=>r.toLowerCase().replace(/[^a-z0-9]+/g,"-");return`${t}-${e(i)}-${e(s.turn.wake_word)}.wav`}function ys(s){return new Date(s).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"})}var qi=`:host{display:block}.scroll{overflow-x:auto}table{width:100%;border-collapse:collapse;font-size:.88rem}th{padding:8px 12px;text-align:right;white-space:nowrap;font-weight:600;font-size:.71rem;text-transform:uppercase;letter-spacing:.07em;color:var(--secondary-text-color);cursor:pointer;user-select:none}th:first-child{text-align:left}th:hover{color:var(--primary-text-color)}th[data-by=true]{color:var(--primary-color)}td{padding:11px 12px;text-align:right;white-space:nowrap;border-top:1px solid color-mix(in srgb,var(--primary-text-color) 10%,transparent);font-variant-numeric:tabular-nums;color:var(--secondary-text-color)}td.who{text-align:left;color:var(--primary-text-color)}td.who button{padding:0;border:none;background:none;color:inherit;font:inherit;cursor:pointer;text-align:left}td.who button:hover{color:var(--primary-color)}td[data-wrong=warn]{color:var(--warning-color, #ffa600)}td[data-wrong=bad]{color:var(--error-color, #db4437);font-weight:600}tr[data-off=true] td{opacity:.5}.none{color:var(--secondary-text-color)}
`;I({path:"health",title:"Health",icon:"mdi:heart-pulse",element:"echolocal-health",order:40});function fe(s){let i=Number(s.state);return s.attributes.unit_of_measurement==="\xB0F"?(i-32)*5/9:i}var ve=[{title:"Version",name:"firmware",show:s=>String(s.attributes.installed_version??"\u2014"),sort:s=>String(s.attributes.installed_version??"")},{title:"Update",name:"firmware",show:s=>s.state==="on"?"waiting":s.state==="off"?"current":s.state,wrong:s=>s.state==="on"?"warn":void 0,sort:s=>s.state},{title:"Wifi",name:"wifi_signal",show:s=>`${Math.round(Number(s.state))} ${s.attributes.unit_of_measurement||"dBm"}`,wrong:s=>Number(s.state)<-80?"bad":Number(s.state)<-70?"warn":void 0},{title:"CPU",name:"cpu_temperature",show:s=>`${Math.round(Number(s.state))}${s.attributes.unit_of_measurement||"\xB0C"}`,wrong:s=>fe(s)>85?"bad":fe(s)>70?"warn":void 0,sort:fe},{title:"Load",name:"load_average",show:s=>Number(s.state).toFixed(2)},{title:"Memory",name:"memory_available",show:s=>`${Math.round(Number(s.state))} ${s.attributes.unit_of_measurement||"MB"}`,wrong:s=>Number(s.state)<40?"bad":Number(s.state)<80?"warn":void 0},{title:"Disk",name:"free_space",show:s=>`${Math.round(Number(s.state))} ${s.attributes.unit_of_measurement||"MB"}`,wrong:s=>Number(s.state)<50?"bad":Number(s.state)<150?"warn":void 0},{title:"Address",name:"ip_address",show:s=>s.state.split(", ")[0]??s.state}],J=class extends v{constructor(){super(...arguments);this.by="";this.down=!1}render(){if(!this.hass)return p;let t=C(this.hass);if(!t.length)return a`<div class="none">No EchoLocal devices yet.</div>`;let e=t.map(n=>this.read(n)),r=this.sort(e);return a`<div class="scroll">
      <table>
        <thead>
          <tr>
...
`;I({path:"wake-words",title:"Wake words",icon:"mdi:waveform",element:"echolocal-words",order:10,admin:!0});var Q=class extends v{constructor(){super(...arguments);this.words=[];this.asked=!1;this.again=()=>this.requestUpdate()}connectedCallback(){super.connectedCallback(),window.addEventListener(rt,this.again)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(rt,this.again)}updated(){this.asked||!this.hass||(this.asked=!0,this.load())}render(){if(!this.hass)return p;let t=this.chosen(),e=new Set(this.words.filter(n=>n.problems.length&&n.wake_word).map(n=>n.wake_word)),r=new Set(t.flatMap(n=>n.words));return a`
    ...
    `}chosen(){return C(this.hass).map(t=>{let r=(X(this.hass,t.id)?.by.get("wake_word")??[]).map(n=>this.hass.states[n.entity_id]?.state).filter(n=>n!=="no_wake_word").filter(n=>!!n&&n!=="unknown"&&n!=="None");return{name:S(t),words:r}}).filter(t=>t.words.length)}async load(){this.words=await be(this.hass)}};Q.styles=b(Ki),c([u({attribute:!1})],Q.prototype,"hass",2),c([m()],Q.prototype,"words",2),c([m()],Q.prototype,"asked",2),Q=c([y("echolocal-words")],Q);var F=class extends v{constructor(){super(...arguments);this.narrow=!1;this.at="";this.made=new Map;this.moved=()=>{this.at=me(this.base(),void 0),this.requestUpdate()}}connectedCallback(){super.connectedCallback(),window.addEventListener("location-changed",this.moved),window.addEventListener("popstate",this.moved)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("location-changed",this.moved),window.removeEventListener("popstate",this.moved)}render(){if(!this.hass)return p;let t=!!this.hass.user?.is_admin,e=ue(t),r=Ai(this.where(),t);return a`
      <header>
